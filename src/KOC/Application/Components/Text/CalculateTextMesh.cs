...
namespace Appalachia.Prototype.KOC.Application.Components.Text
{
    ...
    public class CalculateTextMesh : DynamicTextMesh<CalculateTextMesh>
    {
        ...
        private const string _PRF_PFX = nameof(CalculateTextMesh) + ".";
        ...
        private static readonly ProfilerMarker _PRF_OnUpdateText =
            new ProfilerMarker(_PRF_PFX + nameof(OnUpdateText));
