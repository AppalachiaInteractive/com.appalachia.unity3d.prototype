...
using Appalachia.Prototype.KOC.Components.Animation;
...
namespace Appalachia.Prototype.KOC.Components.Cursors
{
    ...
    public class ComplexCursorInstance : AppalachiaApplicationBehaviour<ComplexCursorInstance>
    {
        ...
        public ComplexCursorComponents components;
        ...
        protected override async AppaTask Initialize(Initializer initializer)
        {
            ...
            using (_PRF_Initialize.Auto())
            {
                ...
                components.Initialize(gameObject, metadata, size);
        ...
        private void HandleCursorMovement()
        {
            using (_PRF_HandleCursorMovement.Auto())
            {
                ...
                var nextPosition = cursorManager.currentPosition;
        ...
        #region Nested type: ComplexCursorComponents

        [Serializable]
        public struct ComplexCursorComponents
        {
            #region Fields and Autoproperties
            ...
            public void Initialize(GameObject gameObject, ComplexCursorMetadata metadata, Vector2 size)
            {
            ...
            private const string _PRF_PFX = nameof(ComplexCursorComponents) + ".";
