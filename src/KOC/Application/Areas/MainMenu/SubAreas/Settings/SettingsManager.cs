...
{
    public class SettingsManager : SubAreaManager<SettingsManager, SettingsMetadata, MainMenuSubArea,
        MainMenuManager, MainMenuMetadata>
    {
        ...
        public override MainMenuSubArea SubArea => MainMenuSubArea.Settings;
        ...
        public void Settings()
        {
            ...
            {
                AppaLog.Context.SubArea.Info(nameof(Settings));
            }
        }
