...
namespace Appalachia.Prototype.KOC.Areas.Functionality.Subwidgets
{
    ...
    public abstract class AreaSubwidgetMetadata<TSubwidget, TSubwidgetMetadata, TWidget, TWidgetMetadata,
                                                TFeature, TFeatureMetadata, TAreaManager, TAreaMetadata> :
        ApplicationSubwidgetMetadata<TSubwidget, TSubwidgetMetadata, TWidget, TWidgetMetadata, TFeature,
