...
namespace Appalachia.Prototype.KOC.Areas.Functionality.Subwidgets.Singleton
{
    ...
    public abstract class AreaSingletonSubwidget<TSubwidget, TSubwidgetMetadata, TISubwidget, TISubwidgetMetadata,
                                                 TWidget, TWidgetMetadata, TFeature, TFeatureMetadata, TAreaManager,
                                                 TAreaMetadata> : ApplicationSingletonSubwidget<TSubwidget,
