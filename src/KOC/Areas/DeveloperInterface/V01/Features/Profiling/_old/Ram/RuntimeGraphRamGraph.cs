        ...
        RuntimeGraphRamMonitor, RuntimeGraphRamText, RuntimeGraphRamSettings>
    {
        ...
        public override void InitializeParameters()
        {
            using (_PRF_SyncParameters.Auto())
            {
                ...
                m_shaderGraphAllocated.arrayMaxSize = GraphShader.ARRAY_MAX_SIZE;
                m_shaderGraphReserved.arrayMaxSize = GraphShader.ARRAY_MAX_SIZE;
                m_shaderGraphMono.arrayMaxSize = GraphShader.ARRAY_MAX_SIZE;
