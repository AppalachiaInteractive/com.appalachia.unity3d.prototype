...
namespace Appalachia.Prototype.KOC.Areas.DeveloperInterface.V01.Features.RuntimeGraphs.Shader
{
    /// <summary>
    ...
    public class GraphShader
    {
        ...
        public const int ARRAY_MAX_SIZE_FULL = 512;
        public const int ARRAY_MAX_SIZE_LIGHT = 128;
        ...
        public int arrayMaxSize = ARRAY_MAX_SIZE_FULL;
