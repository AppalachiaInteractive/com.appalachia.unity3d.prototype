...
{
    public sealed class FPSProfilerServiceMetadata : DeveloperInterfaceMetadata_V01.ServiceMetadata<FPSProfilerService,
        FPSProfilerServiceMetadata, PerformanceProfilingFeature, PerformanceProfilingFeatureMetadata>
    {
        ...
        protected override async AppaTask Initialize(Initializer initializer)
        {
            ...
            {
                initializer.Do(this, nameof(goodFpsColor), () => goodFpsColor = new Color32(118, 212, 58, 255));
                initializer.Do(this, nameof(goodFpsThreshold), () => goodFpsThreshold = 60);
                initializer.Do(this, nameof(cautionFpsColor), () => cautionFpsColor = new Color32(243, 232, 0, 255));
                initializer.Do(this, nameof(cautionFpsThreshold), () => cautionFpsThreshold = 30);
                initializer.Do(this, nameof(criticalFpsColor), () => criticalFpsColor = new Color32(220, 41, 30, 255));
