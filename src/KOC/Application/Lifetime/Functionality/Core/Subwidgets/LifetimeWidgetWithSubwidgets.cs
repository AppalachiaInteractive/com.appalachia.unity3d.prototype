...
namespace Appalachia.Prototype.KOC.Application.Lifetime.Functionality.Core.Subwidgets
{
    ...
    public abstract class
        LifetimeWidgetWithSubwidgets<TElement, TElementMetadata, TWidget, TWidgetMetadata, TFeature,
                                     TFeatureMetadata> : ApplicationWidgetWithSubwidgets<TElement,
            TElementMetadata, TWidget, TWidgetMetadata, TFeature, TFeatureMetadata,
