...
namespace Appalachia.Prototype.KOC.Application.Lifetime.Functionality.Core.Subwidgets
{
    ...
    public abstract class
        LifetimeSubwidgetMetadata<TElement, TElementMetadata, TWidget, TWidgetMetadata, TFeature,
                                  TFeatureMetadata> : ApplicationSubwidgetMetadata<TElement, TElementMetadata,
