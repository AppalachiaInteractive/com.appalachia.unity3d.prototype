...
namespace Appalachia.Prototype.KOC.Components.Graphs
{
    public static class NodyGraphGenerator
    {
        ...
        public static void GenerateTestGraph<TManager, TMetadata>(
            this GraphController target,
            AreaMetadata<TManager, TMetadata> metadata)
