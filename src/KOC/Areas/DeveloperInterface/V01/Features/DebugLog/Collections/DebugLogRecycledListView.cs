...
namespace Appalachia.Prototype.KOC.Areas.DeveloperInterface.V01.Features.DebugLog.Collections
{
    ...
    {
        static DebugLogRecycledListView()
        {
        ...
        private DebugLogState state => _debugLogManager.state;
        ...
        public void Initialize(float logItemHeight)
        {
        ...
        public void OnViewportWidthChanged()
        {
            ...
            _debugLogManager.ValidateScrollPosition();
        }
        ...
        public void SelectAndFocusOnLogItemAtIndex(int itemIndex)
        {
            ...
            _debugLogManager.SetSnapToBottom(false);
        }
        ...
        protected override async AppaTask Initialize(Initializer initializer)
        {
            ...
            using (_PRF_Initialize.Auto())
            {
                scrollView.onValueChanged.AddListener(_ => UpdateItemsInTheList(false));
        ...
        private void CreateLogItemAtIndex(int index)
        {
            ...
            {
                var logItem = _debugLogManager.PopLogItem();
        ...
        private void DestroyLogItemsBetweenIndices(int topIndex, int bottomIndex)
        {
            using (_PRF_DestroyLogItemsBetweenIndices.Auto())
            {
                ...
                for (var i = topIndex; i <= bottomIndex; i++)
                {
                    _debugLogManager.PoolLogItem(logItemsAtIndices[i]);
                }
            }
        }
