...
using Appalachia.Prototype.KOC.Lifetime.Functionality.Features.Cursors.Drivers.Position;
using Appalachia.Prototype.KOC.Lifetime.Functionality.Features.Cursors.Drivers.State;
...
namespace Appalachia.Prototype.KOC.Lifetime.Functionality.Features.Cursors.Drivers
{
    [Serializable]
