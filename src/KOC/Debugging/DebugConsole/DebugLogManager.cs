...
namespace Appalachia.Prototype.KOC.Debugging.DebugConsole
{
    ...
    public class DebugLogManager : SingletonAppalachiaBehaviour<DebugLogManager>
    {
        ...
        [InlineEditor, HideLabel, FoldoutGroup("Settings")]
        public DebugLogManagerSettings settings;

        [InlineProperty, HideLabel, FoldoutGroup("References")]
        public DebugLogManagerReferences references;

        [InlineProperty, HideLabel, FoldoutGroup("State")]
        public DebugLogManagerState state;
        ...
        private void InitializeState(bool full = true)
        {
            using (_PRF_InitializeState.Auto())
            {
                if (settings == null)
                {
                    settings = _debugLogManagerSettings;
                }
        ...
        private void OnValidate()
        {
            using (_PRF_OnValidate.Auto())
            {
                ...
                {
                    references.resizeButton.sprite = settings.window.enableHorizontalResizing
