...
namespace Appalachia.Prototype.KOC.Areas.Functionality.Controls.Tooltips.Control.Base
{
...

    {
        ...
        [PropertyOrder(ORDER_TOOLTIP + 0)]
        [SerializeField]
        public FadeableComponentGroupConfig tooltip;
        ...
        [FormerlySerializedAs("_tooltipText")]
        ...
        protected override void BeforeApplying(TControl control)
        {
            using (_PRF_BeforeApplying.Auto())
            {
                ...
                var textComponent = control.tooltipText.TextMeshProUGUI;
        ...
        protected override void OnApply(TControl control)
        {
            using (_PRF_OnApply.Auto())
            {
                ...
                tooltipText.Apply(control.tooltipText);
                ...
                tooltipText.RectTransform.DisableAllFields = false;
                ...
                tooltipText.RectTransform.HideAllFields = true;
            }
        }
        ...
        protected override void OnInitializeFields(Initializer initializer)
        {
            ...
            FadeableComponentGroupConfig.Refresh(ref tooltip, Owner);
            ...
            TextMeshProUGUIComponentGroupConfig.Refresh(ref tooltipText, Owner);
        }
        ...
        protected override void SubscribeResponsiveConfigs()
        {
            using (_PRF_SubscribeResponsiveConfigs.Auto())
            {
                ...
                tooltipText.SubscribeToChanges(OnChanged);
            }
        }
        ...
        private void FormatText()
        {
            ...
            {
                tooltipText.RectTransform.ResetAnchorsRotationAndScale().ResetSize().Inset(style.TextPadding);
