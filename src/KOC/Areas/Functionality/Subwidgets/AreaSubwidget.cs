...
namespace Appalachia.Prototype.KOC.Areas.Functionality.Subwidgets
{
    ...
    public abstract class AreaSubwidget<TSubwidget, TSubwidgetMetadata, TWidget, TWidgetMetadata, TFeature,
                                        TFeatureMetadata, TAreaManager, TAreaMetadata> : ApplicationSubwidget<
        TSubwidget, TSubwidgetMetadata, TWidget, TWidgetMetadata, TFeature, TFeatureMetadata,
        AreaFeatureFunctionalitySet, IAreaService, IAreaWidget, TAreaManager>
        ...
        where TSubwidgetMetadata : AreaSubwidgetMetadata<TSubwidget, TSubwidgetMetadata, TWidget,
