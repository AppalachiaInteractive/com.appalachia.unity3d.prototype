...
namespace Appalachia.Prototype.KOC.Components.Styling.Overrides
{
    ...
    {
        public OverridableTMP_FontAsset(bool overrideEnabled, TMP_FontAsset value) : base(
            overrideEnabled,
            value
        )
        {
        ...
        public OverridableTMP_FontAsset(Overridable<TMP_FontAsset, OverridableTMP_FontAsset> value) : base(
            value
        )
        {
        }
