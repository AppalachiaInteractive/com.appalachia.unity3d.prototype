...
namespace Appalachia.Prototype.KOC.Areas.Functionality.Controls.Tooltips.Control.Base
{
    ...
    [Serializable]
    [SmartLabelChildren]
    public abstract class BaseTooltipControl<TControl, TConfig> : AppaUIControl<TControl, TConfig>, ITooltipControl
...

    {
        ...
        [SerializeField]
        public TextMeshProUGUIComponentGroup text;
        ...
        protected override void OnRefresh()
        {
            using (_PRF_OnRefresh.Auto())
            {
                ...
                TextMeshProUGUIComponentGroup.Refresh(ref text, TextParent, nameof(text));
        ...
        public TextMeshProUGUIComponentGroup Text => text;
        ...
        public GameObject TextParent => _textParent;
