        ...
        RuntimeGraphAudioManager, RuntimeGraphAudioMonitor, RuntimeGraphAudioText, RuntimeGraphAudioSettings>
    {
        ...
        public override void InitializeParameters()
        {
            using (_PRF_UpdateParameters.Auto())
            {
                ...
                {
                    case Mode.FULL:
                        _shaderGraph.arrayMaxSize = GraphShader.ARRAY_MAX_SIZE_FULL;
                        if (_shaderGraph.image.material == null)
                        {
                            _shaderGraph.image.material = new Material(ShaderFull);
                        }

                        _shaderGraphHighestValues.arrayMaxSize = GraphShader.ARRAY_MAX_SIZE_FULL;
                    ...
                    case Mode.LIGHT:
                        _shaderGraph.arrayMaxSize = GraphShader.ARRAY_MAX_SIZE_LIGHT;
                        if (_shaderGraph.image.material == null)
                        {
                            _shaderGraph.image.material = new Material(ShaderLight);
                        }

                        _shaderGraphHighestValues.arrayMaxSize = GraphShader.ARRAY_MAX_SIZE_LIGHT;
                        if (_shaderGraphHighestValues.image.material == null)
                        {
