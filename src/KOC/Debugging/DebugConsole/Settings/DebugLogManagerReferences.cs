...
{
    [Serializable]
    public class DebugLogManagerReferences : AppalachiaSimpleBase
    {
        ...
        public void InitalizeReferences(
            ...
            DebugLogManagerSettings settings,
            DebugLogManagerState state)
        {
        ...
        private const string _PRF_PFX = nameof(DebugLogManagerReferences) + ".";
