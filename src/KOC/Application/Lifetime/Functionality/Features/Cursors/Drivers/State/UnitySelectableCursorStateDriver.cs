...
namespace Appalachia.Prototype.KOC.Application.Lifetime.Functionality.Features.Cursors.Drivers.State
{
    public class UnitySelectableCursorStateDriver : CursorStateDriver<UnitySelectableCursorStateDriver>
    {
        public UnitySelectableCursorStateDriver()
        {
        }

        public UnitySelectableCursorStateDriver(Object owner) : base(owner)
        {
        }
