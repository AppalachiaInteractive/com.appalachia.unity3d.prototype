...
{
    [CustomEditor(typeof(RuntimeGraphDebugger))]
    internal class RuntimeGraphDebuggerEditor : UnityEditor.Editor
    {
         ...
         * Fix the use of Space to be consistent with "RuntimeGraphManagerEditor".
         * --------------------------------------#1#

        private RuntimeGraphDebugger m_target;
        ...
        {
            m_target = (RuntimeGraphDebugger)target;
        }
...
public override void OnInspectorGUI()
        {
            ...
            RuntimeGraphEditorStyle.HeaderStyle2.contentOffset = Vector2.down * 3f;
            ...
            EditorGUILayout.LabelField(
                ...
                RuntimeGraphEditorStyle.HeaderStyle2
            );
            ...
            for (var i = 0; i < DebugConditions.arraySize; i++)
            {
                ...
                conditionName += GetComparerStringFromDebugVariable(
                                     (RuntimeGraphDebugger.DebugVariable)listItem.FindPropertyRelative("Variable")
                                        .intValue
                                 ) +
                                 " ";
                conditionName += GetComparerStringFromDebugComparer(
                                     (RuntimeGraphDebugger.DebugComparer)listItem.FindPropertyRelative("Comparer")
                                        .intValue
                                 ) +
                                 " ";
            ...
            EditorGUILayout.LabelField("[ ACTIONS ]", RuntimeGraphEditorStyle.HeaderStyle2);
        ...
        private string GetComparerStringFromDebugComparer(RuntimeGraphDebugger.DebugComparer debugComparer)
        {
            switch (debugComparer)
            {
                case RuntimeGraphDebugger.DebugComparer.Less_than:
                    return "<";
                case RuntimeGraphDebugger.DebugComparer.Equals_or_less_than:
                    return "<=";
                case RuntimeGraphDebugger.DebugComparer.Equals:
                    return "==";
                case RuntimeGraphDebugger.DebugComparer.Equals_or_greater_than:
                    return ">=";
                case RuntimeGraphDebugger.DebugComparer.Greater_than:
                    return ">";
        ...
        private string GetComparerStringFromDebugVariable(RuntimeGraphDebugger.DebugVariable debugVariable)
        {
            switch (debugVariable)
            {
                case RuntimeGraphDebugger.DebugVariable.Fps:
                    return "FPS Current";
                case RuntimeGraphDebugger.DebugVariable.Fps_Min:
                    return "FPS Min";
                case RuntimeGraphDebugger.DebugVariable.Fps_Max:
                    return "FPS Max";
                case RuntimeGraphDebugger.DebugVariable.Fps_Avg:
                    return "FPS Avg";

                case RuntimeGraphDebugger.DebugVariable.Ram_Allocated:
                    return "Ram Allocated";
                case RuntimeGraphDebugger.DebugVariable.Ram_Reserved:
                    return "Ram Reserved";
                case RuntimeGraphDebugger.DebugVariable.Ram_Mono:
                    return "Ram Mono";

                case RuntimeGraphDebugger.DebugVariable.Audio_DB:
                    return "Audio DB";
        ...
        {
            var debugPacket = new RuntimeGraphDebugger.DebugPacket();
