        ...
        IApplicationFunctionalityManager
    {
        static ApplicationSubwidget()
        {
            var callbacks = RegisterInstanceCallbacks
               .For<ApplicationSubwidget<TSubwidget, TSubwidgetMetadata, TWidget, TWidgetMetadata, TFeature,
        ...
        [SerializeField] private TSubwidgetMetadata _metadata;
        ...
        public abstract void OnUpdateSubwidget();
        ...
        protected override async AppaTask Initialize(Initializer initializer)
        {
            ...
            using (_PRF_Initialize.Auto())
            {
                initializer.Do(
                    ...
                    () =>
                    {
                        var assetName = $"{gameObject.name}{typeof(TSubwidgetMetadata).Name}";
                        _metadata = AppalachiaObject.LoadOrCreateNew<TSubwidgetMetadata>(
                            assetName,
