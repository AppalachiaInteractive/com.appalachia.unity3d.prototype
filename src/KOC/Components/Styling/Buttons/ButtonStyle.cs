...
namespace Appalachia.Prototype.KOC.Components.Styling.Buttons
{
                               ...
                               IButtonStyle
    {
        ...
        protected override async AppaTask Initialize(Initializer initializer)
        {
            ...
            initializer.Do(this, nameof(_colorMultiplier), () => _colorMultiplier = 1.0f);
            initializer.Do(this, nameof(_fadeDuration),    () => _fadeDuration = .1f);
            initializer.Do(this, nameof(_fontSize),        () => _fontSize = 14f);
            initializer.Do(this, nameof(_alignment),       () => _alignment = TextAlignmentOptions.Center);
        }
