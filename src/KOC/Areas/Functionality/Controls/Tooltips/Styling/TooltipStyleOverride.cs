...
using Appalachia.Prototype.KOC.Areas.Functionality.Controls.Tooltips.Styling.Overrides;
using Appalachia.UI.Core.Layout;
using Appalachia.UI.Core.Layout.Overridable;
...
{
    [Serializable]
    public class TooltipStyleOverride :
        StyleElementOverride<TooltipStyle, TooltipStyleOverride, ITooltipStyle>,
        ITooltipStyle
    {
        #region Fields and Autoproperties

        [SerializeField] private OverridableSprite _triangleSprite;
        [SerializeField] private OverridableAppearanceDirection _direction;
