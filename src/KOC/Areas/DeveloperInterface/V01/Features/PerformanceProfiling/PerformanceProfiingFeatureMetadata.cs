...
{
    public class PerformanceProfiingFeatureMetadata : DeveloperInterfaceMetadata_V01.FeatureMetadata<
        PerformanceProfiingFeature, PerformanceProfiingFeatureMetadata>
    {
        ...
        /// <inheritdoc />
        protected override void SubscribeResponsiveComponents(PerformanceProfiingFeature target)
        {
        ...
        /// <inheritdoc />
        protected override void UpdateFunctionalityInternal(PerformanceProfiingFeature functionality)
        {
