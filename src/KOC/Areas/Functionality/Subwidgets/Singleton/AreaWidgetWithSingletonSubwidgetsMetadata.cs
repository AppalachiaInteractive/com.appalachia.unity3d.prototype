...
namespace Appalachia.Prototype.KOC.Areas.Functionality.Subwidgets.Singleton
{
    ...
    public abstract class AreaWidgetWithSingletonSubwidgetsMetadata<
        TISubwidget, TISubwidgetMetadata, TWidget, TWidgetMetadata, TFeature, TFeatureMetadata, TAreaManager,
        TAreaMetadata> : ApplicationWidgetWithSingletonSubwidgetsMetadata<TISubwidget, TISubwidgetMetadata,
