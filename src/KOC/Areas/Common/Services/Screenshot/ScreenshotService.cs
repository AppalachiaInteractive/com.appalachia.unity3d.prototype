...
using Appalachia.Prototype.KOC.Areas.Common.Services.NotificationOnComplete;
...
{
    public abstract class ScreenshotService<TService, TServiceMetadata, TAreaManager, TAreaMetadata> :
        AreaNotificationOnCompleteService<TService, TServiceMetadata, ScreenshotCompletedHandler, TAreaManager
            , TAreaMetadata>
