...
namespace Appalachia.Prototype.KOC.Areas.DeveloperInterface.V01.Features.PerformanceProfiling.Services.Memory
{
    [CallStaticConstructorInEditor]
    public sealed class MemoryProfilerService : DeveloperInterfaceManager_V01.Service<MemoryProfilerService,
        MemoryProfilerServiceMetadata, PerformanceProfiingFeature, PerformanceProfiingFeatureMetadata>
    {
