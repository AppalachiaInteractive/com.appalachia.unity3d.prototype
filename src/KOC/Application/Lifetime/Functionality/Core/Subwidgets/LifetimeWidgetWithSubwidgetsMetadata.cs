...
namespace Appalachia.Prototype.KOC.Application.Lifetime.Functionality.Core.Subwidgets
{
    ...
    public abstract class
        LifetimeWidgetWithSubwidgetsMetadata<TElement, TElementMetadata, TWidget, TWidgetMetadata, TFeature,
                                             TFeatureMetadata> : ApplicationWidgetWithSubwidgetsMetadata<
            TElement, TElementMetadata, TWidget, TWidgetMetadata, TFeature, TFeatureMetadata,
